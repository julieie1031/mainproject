...
<form id='searchForm' action="/board/list" method='get'>
	<table >
		<tr class="img1">
			...
			<td style="padding-left: 130px"><a href="/board/register"><img
					src="../resources/images/community/register.png" alt="..."
					width="40px" height="39px" style="margin-right: 10px;"></a></td>
	...
	<div>
		<c:forEach var="listView" items="${list}">
			<table 
				style="text-align: right; width: 500px; font-size: 13px;">



				<tr class="line">
					<td rowspan="5" width="100"><a class='move'
									href='<c:out value = "${listView.bno }"/>'> <img
						src="../resources/images/community/dog.png" width="170px"
						height="170px" align="left"></td>

				</tr>
				<tr>
					<td colspan="4"><a class='move'
									href='<c:out value = "${listView.bno }"/>'> 
									<c:out value="${listView.title }" /></a></td>
				</tr>
				<tr>
					<td colspan="4"><a class='move'
									href='<c:out value = "${listView.bno }"/>'> ${listView.content}</td>
				</tr>
				<tr>
					<td colspan="4"><a class='move'
									href='<c:out value = "${listView.bno }"/>'> ${listView.board_updateDate}</td>
				</tr>
				<tr>
					<td width="15%"><img
	...
	<ul>
		<c:if test="${pageMaker.prev }">
			<td><li class="paginate_button"><a
					href="${pageMaker.startPage-1 }">&laquo;&laquo;</a></li></td>
		</c:if>


		<c:forEach var="num" begin="${pageMaker.startPage }"
			end="${pageMaker.endPage }">
			<td><li class ="paginate_button ${pageMaker.cri.pageNum==num?"active":""}"><a
					href="${num }">${num }</a></li></td>
		</c:forEach>
		<c:if test="${pageMaker.next }">
			<td><li class="paginate_button"><a
					href="${pageMaker.endPage+1 }">&raquo;&raquo;</a></li></td>
		</c:if>
	</ul>
